...
from beta_visualization import (
    plot_beta,
    plot_alpha,
    plot_alpha_variant,
    plot_beta_IPF,
...
from identify_beta_grains import identify_beta_grains, label_alpha_variants
...
if __name__ == "__main__":
    ebsdFilePaths = glob.glob("./preprocessing/ctf_files/*")
